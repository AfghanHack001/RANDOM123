...
'\x1b[1;91m' ༄Mr𝙧᭄•─────────────────•༄BLACK𝙧᭄
'\x1b[1;91m'   Author      ||    BLACK TEAM     
'\x1b[1;92m'   Github      ||     AfghanHack00q  
'\x1b[1;93m'   FB ID       ||    Edris Malik
...
def main_apv():
    ...
    print logo
    try:
        key1=open("/sdcard/public.txt",'r').read()
    except IOError:
        os.system("clear")
        print logo
    ...
    r1=requests.get("https://raw.githubusercontent.com/AfghanHack001/Paid/main/public.txt").text
    if key1 in r1:
        main_system()
    else:
        os.system("clear")
        ...
        os.system("xdg-open https://wa.me/+99787389807")
